...
export const Button = ({ children, className, icon, variant = "primary", ...props }: ButtonProps) => {
  ...
  return (
    ...
    "px-4 py-1 border-gray-200 flex gap-2 dark:text-gray-400 text-gray-600 items-center rounded-lg text-xs",
      variant === "primary" && "px-4 border border-t-gray-500 shadow-inner shadow-gray-400 dark:shadow-gray-700 py-1 text-white hover:shadow-none hover:bg-gray-800 dark:bg-gray-950 bg-gray-200 border-gray-600 hover:text-white",
